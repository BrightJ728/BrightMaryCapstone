...
<!-- end of graph -->
  <div class="inner-cont " >
      ...
      <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="view/firecases.php">Fire Cases</a>
          </li>
          <li class="nav-item">
...
<h3>Dashboard: Fire Fighter's Portal</h3>
  ...
  <div class="row row-cols-3 row-cols-lg-3 g-3 g-lg-3">
   <div class="col">
    ...
    <div class="p-4 border bg-primary" > <br>Total Users <br> <?= Users(); ?><br> </div>
   </a></div>
    <div class="col">
    <a href="view/firecases.php" id="cases">
      <div class="p-4 border bg-danger"><br>Fire Detected <br> <?= firecases(); ?></div>
    </a></div>
    <div class="col">
    <a href="view/locations.php" id="locations">
      <div class="p-4 border bg-success"><br>Locations <br> <?= locations(); ?></div>
    </a></div>
  
<br>
<br>
<br>
<h3 style="width:100%;margin-top:5%;color:red; font-weight:bold">Analytics: Number of Fire incidents per Week</h3>
